...
Reads evals/runs/claude_code_max_long/{plain,flint}_r*.jsonl. Reports per-variant:
...
OUT = ROOT / "evals" / "runs" / "claude_code_max_long"
TASKS = ROOT / "evals" / "claude_code_max_long_prompts.jsonl"
