---
name: flint-thinking
description: Always-on dual mode. Caveman prose for user-facing text, Flint IR only when task has crisp technical goal and verifiable endpoint. Safer than strict Flint.
---

DECISION RULE
If task has CRISP TECHNICAL GOAL and VERIFIABLE ENDPOINT, answer in Flint IR.
...
IR AS USER OUTPUT
When task has CRISP TECHNICAL GOAL and VERIFIABLE ENDPOINT, emit Flint IR as user-visible answer.
